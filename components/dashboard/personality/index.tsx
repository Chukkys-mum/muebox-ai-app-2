...
export default function Personality(props: Props) {
  ...
  return (
    <DashboardLayout
      ...
      description="Personality and Tone of Voice settings." products={[]} subscription={undefined}>
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="w-1/2">
                ...
                <p className="mt-1 text-sm font-medium text-zinc-500 dark:text-zinc-400 md:mt-4 md:text-base">
                 Personality Profiles are used to manage communication styles. 
                </p>
              </div>
              <Link href="/dashboard/personality/profiles" passHref>
                <Button
          ...
          <Card className="mb-5 h-min max-w-full pt-8 pb-6 px-6 dark:border-zinc-800">
            <div className="flex justify-between items-center mb-6">
              <div className="w-1/2">
                ...
                <p className="mt-1 text-sm font-medium text-zinc-500 dark:text-zinc-400 md:mt-4 md:text-base">
                Connect your Gmail, Outlook, or other email accounts to allow the AI to learn your communication style. By syncing, the AI will adapt your unique tone, enabling it to respond naturally and contextually in different situations.
                </p>
              </div>
              <Link href="/dashboard/personality/profiles" passHref>
                <Button
