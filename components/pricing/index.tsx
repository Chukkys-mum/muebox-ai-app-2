      ...
      <InnerContent extra="z-[1] max-w-full md:max-w-full xl:max-w-[1170px]">
        ...
        <div className="mb-20 w-full flex-col px-5 md:px-0">
          <div className="flex flex-col items-center justify-center px-5 text-start md:px-10 xl:px-0">
            ...
            <h1 className="w-full text-center text-[28px] font-extrabold leading-[38px] text-foreground dark:text-white md:w-[90%] md:text-[40px] md:leading-[50px] lg:w-[64%] xl:w-[70%] xl:text-[48px] xl:leading-[60px] 2xl:w-[60%]">
        ...
        <div className="mb-5 flex w-full flex-col gap-5 px-5 md:px-0 lg:flex-row">
          ...
          <Card className="mx-auto max-w-[377px] flex-col items-center border-zinc-200 bg-white p-4 !pt-[26px] dark:border-zinc-800 dark:bg-zinc-950 md:p-[26px]">
            ...
            <div className="z-[1] mb-10 flex w-full flex-col rounded-md bg-zinc-100 px-4 pb-10 pt-10 dark:bg-zinc-900 md:px-[34px]">
              ...
              <Link href="/dashboard/signin">
                <Button className="mt-auto flex h-[unset] w-full items-center justify-center rounded-md px-4 py-5 text-base font-medium">
                  Get started now
                </Button>
              </Link>
            </div>
          ...
          {products.map((product) => {
            ...
            if (product.id === 'prod_QfhYC6AAtI5IKW') {
              ...
              return (
                ...
                >
                  ...
                  <div className="z-[1] mb-10 flex w-full flex-col rounded-md border-[1px] border-zinc-800 bg-zinc-900 px-4 pb-10 pt-10 dark:bg-zinc-800 md:px-8">
                    <div className="mb-8 flex flex-row justify-center">
                    ...
                    <Button
                      ...
                      className="dark mt-auto flex h-[unset] w-full items-center justify-center rounded-md px-4 py-5 text-base font-medium"
                    >
          ...
          <Card className="mx-auto max-w-[377px] flex-col items-center border-zinc-200 bg-zinc-950 p-4 px-6 pt-[26px] dark:border-zinc-950 dark:bg-zinc-900">
            ...
            <div className="z-[1] mb-10 flex w-full flex-col rounded-md border-[1px] border-zinc-800 bg-zinc-900 px-4 pb-10 pt-10 dark:bg-zinc-800 md:px-8">
              ...
              <Button className="dark mt-auto flex h-[unset] w-full items-center justify-center rounded-md px-4 py-5 text-base font-medium">
                {subscription ? 'Manage' : 'Get started now'}
              </Button>
            </div>
            {/* Features */}
          ...
          <Card className="mx-auto max-w-[377px] flex-col items-center border-zinc-200 bg-white p-4 !pt-[26px] dark:border-zinc-800 dark:bg-zinc-950 md:p-[26px]">
            ...
            <div className="z-[1] mb-10 flex w-full flex-col rounded-md bg-zinc-100 px-4 pb-10 pt-10 dark:bg-zinc-900 md:px-[34px]">
              <div className="mb-8 flex flex-row justify-center">
                ...
                <div className="flex flex-col pb-1 text-foreground dark:text-white">
            ...
            <div className="flex w-full flex-col">
              <div className="mb-8 flex items-center">
                <HiOutlineCheckCircle className="mr-2.5 h-5 w-5 text-foreground dark:text-white" />
                <span className="text-sm font-medium xl:text-base">
                  Unlimited Premium Essays / year
                </span>
              </div>
          ...
          {products.map((product) => {
            ...
            if (product.id === 'prod_QfhcnVrnDf2I75') {
              if (!price) return null;
              return (
                <Card
                  key={product.id}
                ...
                >
                  <div className="mx-auto mb-1 flex w-max py-4">
                    ...
                    <Badge
                      variant="outline"
                      className="w-max px-4 py-2 text-foreground dark:border-none dark:bg-zinc-800 dark:text-white"
                    >
                      SAVE 35%
                    </Badge>
                  </div>
        ...
        <div className="mt-8 flex flex-col items-center px-5 md:px-0">
          <div className="mb-5 flex items-center">
            <MdAttachMoney className="mr-1 h-6 w-6 text-foreground dark:text-white" />
            <span className="text-sm font-medium text-foreground dark:text-white">
              14-Days money back
            </span>
          </div>
          <div className="mb-5 flex items-center">
            <MdLock className="dark:Text-white mr-1 h-6 w-6 text-foreground dark:text-white" />
            <span className="text-sm font-medium text-foreground dark:text-white">
              Secured AES-256 Encrypted payments powered by Stripe:
            </span>
          </div>
          <div className="mb-5 flex items-center">
            <FaCcVisa className="mr-2.5 h-[30px] w-[30px] text-foreground dark:text-white" />
            <FaCcMastercard className="mr-2.5 h-[30px] w-[30px] text-foreground dark:text-white" />
            <FaCcPaypal className="mr-2.5 h-[30px] w-[30px] text-foreground dark:text-white" />
            <FaCcApplePay className="mr-2.5 h-[30px] w-[30px] text-foreground dark:text-white" />
            <FaCcAmex className="h-[30px] w-[30px] text-foreground dark:text-white" />
          </div>
        </div>
